  ...
  while (true) {
    switch (this._state) {
      ...
      case 'PART_BODY':
        ...
        // This can probably be simplified by modifying the i value used
        // by the do loop.
...
MultipartParser.prototype.end = function() {
  if (this._state !== 'EPILOGUE') {
    throw new Error(
      'MultipartParser.UnexpectedEnd: end() was called while in ' +
      this._state + ' at offset ' + this._offset
    );
  }
};
