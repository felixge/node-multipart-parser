...
function MultipartParser() {
  ...
  this._headerField        = '';
  this._headerValue        = '';
  this._headerBuffer       = new Buffer(200);
  this._headerCursor       = 0;
}
      ...
      case 'HEADER_FIELD':
        switch (byte) {
          case COLON:
            ...
            this._headerField =
              this._headerBuffer.toString('ascii', 0, this._headerCursor);
            this._headerCursor = 0;
            break
          case CR:
            if (this._headerCursor) {
          ...
          default:
            ...
            if (this._headerCursor >= 200) {
              this._state = 'HEADER_BUFFER_OVERFLOW';
              continue;
            }

            this._headerBuffer[this._headerCursor++] = byte | 32;
            break;
        }
        break;
      case 'HEADERS_END':
        ...
        break;
      case 'HEADER_VALUE':
        // worth avoiding a trim? maybe not
        //if (!this._headerCursor && byte === 32) continue;
        ...
        if (byte === CRLF[this._counter++]) {
          if (this._counter === CRLF.length) {
            ...
            this._part.addHeader(this._headerField, this._headerValue.trim());
            this._headerField = '';
            this._headerValue = '';
            this._counter     = 0;
            this._state       = 'HEADER_FIELD';
        ...
        this._headerBuffer[this._headerCursor++] = byte;
        break;
      case 'PART_BODY':
        this._marker = i;
